...
ARTIFACT_ROOT_DEFAULT="/root/data/jjj/VerifyReport/rl_root"
...
# export WANDB_API_KEY="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"
export WANDB_API_KEY="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"
...
PROJECT_NAME="verigraph_filtered"
EXP_NAME="dapo_filtered"
LOGGER_BACKENDS="['console','wandb']"

# MODEL_PATH="/root/data/jjj/VerifyReport/model_checkpoints/sft_v1_multiturn_0322/v3-20260322-213016/checkpoint-356"
MODEL_PATH="/root/data/jjj/VerifyReport/model_checkpoints/sft_v3_multiturn_0404/v2-20260404-174422/checkpoint-1911"
CKPTS_DIR="/root/data/jjj/VerifyReport/model_checkpoints/rl_v2_filtered"

RUN_PREPROCESS=true
RAW_JSON="/root/data/jjj/VerifyReport/data/training/rl_v2_filtered.json"
# RAW_JSON="/root/data/jjj/VerifyReport/data/training/rl_v2_no_research.json"
CONTEXT_ROOT_DIR="/root/data/jjj/VerifyReport/data/training/context"
RL_DATA_DIR="${ROOT_DIR}/data/verigraph_rl"
TRAIN_FILE="${RL_DATA_DIR}/train.parquet"
TEST_FILE="${RL_DATA_DIR}/test.parquet"

# Reward judge endpoint. Fill these three fields directly.
# They are passed to reward_model.reward_kwargs.* for verigraph reward.
VERIGRAPH_JUDGE_MODEL="gpt-4o-mini"
VERIGRAPH_JUDGE_API_BASE="https://aigc.x-see.cn/v1/"
VERIGRAPH_JUDGE_API_KEY="sk-KtLnEKaFE9HV0hR6qLS6NXZnFjXVa1uofbUnkwhQzB75Xh2y"
